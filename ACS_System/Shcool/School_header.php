...
?>
<div id="header">
			<input type="button" name="top" value="TOP" onclick="location.href='http://localhost/ACS_System/Shcool/School_Home.php'"style="position: absolute; left: 13em; top: 10px"/>
