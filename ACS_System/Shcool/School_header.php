...
?>
<div id="header">
			<input type="button" name="top" value="TOP" onclick="location.href='http://localhost/ACS_System/Shcool/School_Home.php'"style="position: absolute; left: 13em; top: 10px;font-size:16px;"/>
...
<div id="select_menu">
	...
	<ul id="menu">
		...
		<li>書類管理
			<ul style="list-style:none;">
				<li><a href="http://localhost/ACS_System/Shcool/New_purchase_order/Entry.php" target="_self">注文書作成</a></li>
				<li><a href="http://localhost/ACS_System/Shcool/Purchase_order_selection/Selection.php" target="_self">注文書選択</a></li>
				<li><a href="http://localhost/ACS_System/Shcool/New_report/Entry.php" target="_self">報告書作成</a></li>
