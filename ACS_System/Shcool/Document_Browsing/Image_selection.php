...
//日付検索
		if(isset($_POST['select_year'])){
			$s_year=document.forms.sort_period.select_year;
			$s_manth=document.forms.sort_period.select_manth;
		...
		$date_result= $pdo->prepare("select tyuumon.tm_id,tyuumon.t_date,hinmei.hin_janru,tyuumon_master.tm_seisakubutu,gazou.gazou_path
									from tyuumon,tyuumon_master,hinmei,gazou
									where tyuumon.tm_id=tyuumon_master.tm_id and tyuumon.hin_id=hinmei.hin_id and gazou.tm_id=tyuumon.tm_id
