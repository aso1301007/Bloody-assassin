...
//	  	echo $row['user_id'];
  	...
  	?>
  	<td><form action="t_user_delete_kakunin.php" method="post" enctype="multipart/form-data">
...
<div style="text-align:center; margin-bottom:20px;">
	<input type="button" value="検索をやり直す" onclick="location.href='t_user_delete.php'"/>
</div>
</body>
</html>
